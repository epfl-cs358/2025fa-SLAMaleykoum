...
/**
 * @brief Initializes I2C communication and configures the AS5600 encoder.
 * 
 * Sets up the encoder with:
 * - Clockwise rotation direction
 * - Hysteresis level 2 (noise suppression)
 * - Slow filter level 2 (jitter reduction)
 * 
