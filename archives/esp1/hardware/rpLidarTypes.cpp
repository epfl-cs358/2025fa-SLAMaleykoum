...
rp_descriptor_t resp_descriptor1[]={{0xA5,0x5A,0x54,0x00,0x00,0x40,0x82},//Legacy Version
...
rq_message_t req_message1[]={{0xA5,0x25}, //Stop
							{0xA5,0x40}, //Reset
							{0xA5,0x20}, //Scan
...
rq_Packet_t req_Express1[]={{0xA5,0x82,0x05,0x00,0x00,0x00,0x00,0x00,0x22}, //Legacy Mode
